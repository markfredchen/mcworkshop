...
public interface DJServiceMapper {
	...
	@Insert("INSERT INTO company(name, companyNo, commercialNo, organizationCode, docNo, registerAddress, operateAddress, registerAsset, branchNumber, regionID, commercialStatusID, taxStatusID, economyEntityID, economyNatureID, industryType, collectMethodID, affiliateRegionID, taxNatureID, taxTypeID, establishDate, materialDate, handleDate, issueDate, moveInDate, transferDate, taxCancellation, commercialCancellation, taxCollector, merchat, affliateMerchat, isEDeclaration, isReceiptBought, isNormalTaxer, certificationNo, companyIdentifier, infoCardNo, operationStartYear, operationEndYear, validStartYear, validEndYear, operationMethod, normalTaxerAuthDate, operationScope, remarkables, unifiedCode, taxMngCode, taxRegNo, purchasedBookNo, bank, bankAccount, taxAccount, ownerContactID, otherContactID, shareholderContactID, shareRatio, branches, taxOrgID, isA, isB, isC, isD, isE, isF, isG, isH, isI, isJ, isK, isL, isM, isN, isO, isP, isQ, aDate, bDate, cDate, dDate, eDate, fDate, gDate, hDate, iDate, jDate, kDate, lDate, mDate, nDate, numberOfO, numberOfP, numberOfQ, partyName, partyLeader, area, ownership, sleepingRoomNumbers, usageArea, rentArea, spareArea, companyArea, localEmployeeNumber, employeeNumber, landUsageID, factoryArea, factoryUsageArea, factoryRentArea, factoryControlArea, factoryActualArea, isRent, currencyID, isR, isS, isT, isU, isV, isW, rDate, sDate, tDate, uDate, vDate, wDate)"
			+ " VALUES(#{name}, #{companyNo}, #{commercialNo}, #{organizationCode}, #{docNo}, #{registerAddress}, #{operateAddress}, #{registerAsset}, #{branchNumber}, #{regionID}, #{commercialStatusID}, #{taxStatusID}, #{economyEntityID}, #{economyNatureID}, #{industryType}, #{collectMethodID}, #{affiliateRegionID}, #{taxNatureID}, #{taxTypeID}, #{establishDate}, #{materialDate}, #{handleDate}, #{issueDate}, #{moveInDate}, #{transferDate}, #{taxCancellation}, #{commercialCancellation}, #{taxCollector}, #{merchat}, #{affliateMerchat}, #{isEDeclaration}, #{isReceiptBought}, #{isNormalTaxer}, #{certificationNo}, #{companyIdentifier}, #{infoCardNo}, #{operationStartYear}, #{operationEndYear}, #{validStartYear}, #{validEndYear}, #{operationMethod}, #{normalTaxerAuthDate}, #{operationScope}, #{remarkables}, #{unifiedCode}, #{taxMngCode}, #{taxRegNo}, #{purchasedBookNo}, #{bank}, #{bankAccount}, #{taxAccount}, #{ownerContact.contactID}, #{otherContact.contactID}, #{shareholderContact.contactID}, #{shareRatio}, #{branches}, #{taxOrgID}, #{isA}, #{isB}, #{isC}, #{isD}, #{isE}, #{isF}, #{isG}, #{isH}, #{isI}, #{isJ}, #{isK}, #{isL}, #{isM}, #{isN}, #{isO}, #{isP}, #{isQ}, #{aDate}, #{bDate}, #{cDate}, #{dDate}, #{eDate}, #{fDate}, #{gDate}, #{hDate}, #{iDate}, #{jDate}, #{kDate}, #{lDate}, #{mDate}, #{nDate}, #{numberOfO}, #{numberOfP}, #{numberOfQ}, #{partyName}, #{partyLeader}, #{area}, #{ownership}, #{sleepingRoomNumbers}, #{usageArea}, #{rentArea}, #{spareArea}, #{companyArea}, #{localEmployeeNumber}, #{employeeNumber}, #{landUsageID}, #{factoryArea}, #{factoryUsageArea}, #{factoryRentArea}, #{factoryControlArea}, #{factoryActualArea}, #{isRent}, #{currencyID}, #{isR}, #{isS}, #{isT}, #{isU}, #{isV}, #{isW}, #{rDate}, #{sDate}, #{tDate}, #{uDate}, #{vDate}, #{wDate})")
