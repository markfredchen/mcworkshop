 ...
 *
 */
public class TMBoxRealDataReportPage extends InnerBasePage {

    private static final long serialVersionUID = 1L;

    @Override
    protected Panel getContentPanel(String id) {
        return new TMBoxRealDataReportPanel(id, FXApplication.get().getTmboxRealData(), "外汇TMBOX实盘报表");
    }
    ...
    protected String getBrowserTitle() {
        return WicketMessageUtil.getResourceString("fx.header.navi.menu.sub.spt.fx.tmbox.real.data");
    }
